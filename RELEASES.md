...
A design version and a specification version are one release when they are committed together and cite each other. Tags and OpenTimestamps proofs are added after the maintainer's read; a version without a tag is published but not yet released.
...
- review status: v0.6 reviewed by GPT (`docs/intendment-design-v0.6-review-gpt.md`, folded); Codex review of v0.6 outstanding; v0.7 unreviewed
- tag: none yet
...
- review status: GPT at f2a1b81; Codex outstanding
- tag: none
